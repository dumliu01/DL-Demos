...
def main():
    ...
    dataloader_train, sampler = get_dataloader(en_train, zh_train,batch_size,True)
    ...
    # Optional: load model
    ckpt_path = 'dldemos/Transformer_ver1/model_latest.pth'
    optim_path = 'dldemos/Transformer_ver1/optimizer_latest.pth'
    ...
    for epoch in range(begin_epoch, n_epochs):
        ...
        if device_id == 0:
            latest_model = 'dldemos/Transformer_ver1/model_latest.pth'
            latest_optimizer = 'dldemos/Transformer_ver1/optimizer_latest.pth'
            model_file = f'dldemos/Transformer_ver1/model_{epoch}.pth'
            optim_file = f'dldemos/Transformer_ver1/optimizer_{epoch}.pth'
